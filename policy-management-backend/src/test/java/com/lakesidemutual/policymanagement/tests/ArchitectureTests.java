...
@AnalyzeClasses(
		packages = {"com.lakesidemutual.policymanagement","org.microserviceapipatterns.domaindrivendesign"},
		importOptions = {DontIncludeTests.class}
		)
public class ArchitectureTests {
	private final static String ROOT_PKG = "com.lakesidemutual.policymanagement..";
	private final static String INTERFACES_PKG = "com.lakesidemutual.policymanagement.interfaces..";
	private final static String APPLICATION_PKG = "com.lakesidemutual.policymanagement.application..";
	private final static String DOMAIN_PKG = "com.lakesidemutual.policymanagement.domain..";
	private final static String INFRASTRUCTURE_PKG = "com.lakesidemutual.policymanagement.infrastructure..";
	private final static String DTOS_PKG = "com.lakesidemutual.policymanagement.interfaces.dtos..";
