...
@AnalyzeClasses(
		packages = {"com.lakesidemutual.customerselfservice","org.microserviceapipatterns.domaindrivendesign"},
		importOptions = {DontIncludeTests.class}
		)
public class ArchitectureTests {
	private final static String ROOT_PKG = "com.lakesidemutual.customerselfservice..";
	private final static String INTERFACES_PKG = "com.lakesidemutual.customerselfservice.interfaces..";
	private final static String APPLICATION_PKG = "com.lakesidemutual.customerselfservice.application..";
	private final static String DOMAIN_PKG = "com.lakesidemutual.customerselfservice.domain..";
	private final static String INFRASTRUCTURE_PKG = "com.lakesidemutual.customerselfservice.infrastructure..";
	private final static String DTOS_PKG = "com.lakesidemutual.customerselfservice.interfaces.dtos..";
