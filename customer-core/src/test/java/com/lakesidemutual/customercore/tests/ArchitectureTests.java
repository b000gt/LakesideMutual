...
public class ArchitectureTests {
	...
	private final static String INTERFACES_PKG = "com.lakesidemutual.customercore.interfaces..";
	private final static String APPLICATION_PKG = "com.lakesidemutual.customercore.application..";
	private final static String DOMAIN_PKG = "com.lakesidemutual.customercore.domain..";
	private final static String INFRASTRUCTURE_PKG = "com.lakesidemutual.customercore.infrastructure..";
	private final static String DTOS_PKG = "com.lakesidemutual.customercore.interfaces.dtos..";
