...
documentation for the Customer Core, go to [http://localhost:8110/swagger-ui/](http://localhost:8110/swagger-ui/). The native Swagger file is available at [http://localhost:8110/v2/api-docs](http://localhost:8110/v2/api-docs).
